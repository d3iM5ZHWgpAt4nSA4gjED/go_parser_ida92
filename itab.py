...
class ItabElem():
    ...
    def parse(self):
        ...
        while True:
            if len(ic.get_ea_name(curr_addr)) > 0:
            ...
            if idaapi.get_func(meth_addr):
                meth_name = ic.get_ea_name(meth_addr)
        ...
        idc.set_name(self.addr, itab_elem_name,flags=ic.SN_FORCE)
...
def parse_itab(moddata, type_parser):
    ...
    itab_addr = ic.BADADDR
    itab_end_addr = ic.BADADDR
    itab_cnt = 0
