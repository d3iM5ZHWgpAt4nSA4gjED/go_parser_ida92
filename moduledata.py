...
def find_first_moduledata_addr_by_brute(magic_number):
    first_moduledata_addr = ic.BADADDR
...
def find_first_moduledata_addr():
    ...
    if not is_stripped(): # not stripped, find firstmoduledata by symbol name
        ...
        if first_moduledata_addr == ic.BADADDR:# and mdata_seg_addr == 0:
            ...
            for tmp_magic_number in magic_numbers:
                ...
                if first_moduledata_addr != ic.BADADDR:
                    magic_number = tmp_magic_number
                    break
...
class ModuleData():
    ...
    def __init__(self, start_addr, magic_number):
        ...
        self.pcheader_addr   = ic.BADADDR  # Starts from version 1.16
        self.pclntbl_addr    = ic.BADADDR
        self.pclntbl_sz      = 0
        self.pclntbl_cap     = 0
        self.ftab_addr       = ic.BADADDR
        self.func_sz         = 0
        self.ftab_cap        = 0
        self.filetab_addr    = ic.BADADDR
        self.srcfile_sz      = 0
        self.srcfile_tab_cap = 0
        self.findfunctab     = ic.BADADDR
        self.min_pc          = ic.BADADDR
        self.max_pc          = ic.BADADDR
        self.text_addr       = ic.BADADDR
        self.etext_addr      = ic.BADADDR
        self.noptrdata_addr  = ic.BADADDR
        self.enoptrdata_addr = ic.BADADDR
        self.data_addr       = ic.BADADDR
        self.edata_addr      = ic.BADADDR
        self.bss_addr        = ic.BADADDR
        self.ebss_addr       = ic.BADADDR
        self.noptrbss_addr   = ic.BADADDR
        self.enoptrbss_addr  = ic.BADADDR
        self.end_addr        = ic.BADADDR
        self.gcdata_addr     = ic.BADADDR
        self.gcbss_addr      = ic.BADADDR
        self.types_addr      = ic.BADADDR
        self.etypes_addr     = ic.BADADDR
        self.textsecmap_addr = ic.BADADDR
        self.textsecmap_len  = 0
        self.textsecmap_cap  = 0
        self.typelink_addr   = ic.BADADDR
        self.type_cnt        = 0
        self.type_cap        = 0
        self.itablink_addr   = ic.BADADDR
        self.itab_cnt         = 0
        self.itab_cap        = 0
        self.ptab_addr       = ic.BADADDR
        self.ptab_sz         = 0
        self.ptab_cap        = 0
        self.pluginpath      = ""
        self.modulename      = ""
        self.hasmain         = False
        self.next            = ic.BADADDR

        # Go 1.16 +
        self.funcnametab_addr = ic.BADADDR
        self.funcnametab_sz   = 0
        self.funcnametab_cap  = 0
        self.cutab_addr       = ic.BADADDR
        self.cutab_sz         = 0
        self.cutab_cap        = 0
        self.pctab_addr       = ic.BADADDR
        self.pctab_sz         = 0
        self.pctab_cap        = 0
        # Go 1.18+
        self.rodata_addr      = ic.BADADDR
        self.gofunc_addr      = ic.BADADDR
    ...
    def parse(self, is_test=False):
        ...
        idc.set_name(self.start_addr, "runtime.firstmoduledata", flags=ic.SN_FORCE)
        ic.auto_wait()
        ...
        if self.magic_number == common.MAGIC_112:
            ...
            ic.create_strlit(modulename_addr, modulename_addr+modulename_len)
            ic.auto_wait()

            ic.create_strlit(pluginpath_addr, pluginpath_addr+pluginpath_len)
            ic.auto_wait()
